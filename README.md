...
Its sole existence is because I find it hard to pack images within existing game engines and be used in a CLI environment.
One of which I'm using has one but doesn't expose the button to let me pack it when I need one. Thus, this Texture Packer was compiled.
